    ...
    <div className={styles.card}>
      ...
      <div className={styles.content}>
        <div className={styles.header}>
          ...
          <div className={styles.rating}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M8 12.4l-4.2 2.6 1.1-4.8L1 6.6l4.9-.4L8 1.6l2.1 4.6 4.9.4-3.9 3.6 1.1 4.8L8 12.4z" fill="#FFD700"/>
            </svg>
        ...
        <p className={styles.location}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M8 0C5.24 0 3 2.24 3 5c0 1.17.36 2.25.97 3.15L8 14l4.03-5.85C12.64 7.25 13 6.17 13 5c0-2.76-2.24-5-5-5zm0 7c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" fill="#666"/>
          </svg>
          {propertyData.location.city}, {propertyData.location.address}
        </p>
        <p className={styles.host}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M8 0a4 4 0 100 8 4 4 0 000-8zM4 12a4 4 0 00-4 4v2h16v-2a4 4 0 00-4-4H4z" fill="#666"/>
          </svg>
          Anfitrión: {propertyData.hostName}
        </p>
        
        <div className={styles.priceContainer}>
          <span className={styles.price}>${propertyData.price.toLocaleString()}</span>
